...
/**
 * The test class DocumentTest tests the Document class.
 *
...
public class DocumentTest {
    ...
    public void testCount() {
        assertEquals(7, testDoc.getSecCount());
    }
    ...
    public void testaddAtPos() {
        ...
        testDoc.addAtPos(3, sec);
        assertEquals(sec, testDoc.getSection(3));
    }
    
    @Test
    public void testRemove() {
        testDoc.removeSection(2);
        assertEquals(6, testDoc.getSecCount());
    }
    
    @Test (expected = IllegalStateException.class)
    public void testNewPrecon1() {
        testDoc.newDoc("BadDoc");
    }
    
    @Test (expected = IllegalArgumentException.class)
    public void testNewPrecon2() {
        testDoc.closeDoc();
        testDoc.newDoc(null);
    }
    
    @Test (expected = IllegalArgumentException.class)
    public void testNewPrecon3() {
        testDoc.closeDoc();
        testDoc.newDoc("");
    }
    
    @Test (expected = IllegalStateException.class)
    public void testSavePrecon() {
        testDoc.closeDoc();
        testDoc.saveDoc();
    }
    
    @Test (expected = IllegalStateException.class)
    public void testClosePrecon() {
        testDoc.closeDoc();
        testDoc.closeDoc();
    }
    ...
    public void testOpen() {
        testDoc.saveDoc();
        testDoc.closeDoc();
        testDoc.openDoc("Cats vs. Dogs");
        assertEquals(7, testDoc.getSecCount());
    }
    
    @Test (expected = IllegalStateException.class)
    public void testOpenPrecon() {
        testDoc.openDoc("Cats vs. Dogs");
    }
    
    @Test (expected = IllegalStateException.class)
    public void testSaveHTMLPrecon() {
        testDoc.closeDoc();
        testDoc.saveToHTML();
    }
